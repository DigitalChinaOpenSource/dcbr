...
import (
	...
	"github.com/DigitalChinaOpenSource/TiDB-for-PostgreSQL/util/israce"
...
func CheckClusterVersion(ctx context.Context, client pd.Client) error {
	...
	for _, s := range stores {
		...
		// BR(https://github.com/DigitalChinaOpenSource/dcbr/pull/233) and TiKV(https://github.com/tikv/tikv/pull/7241) have breaking changes

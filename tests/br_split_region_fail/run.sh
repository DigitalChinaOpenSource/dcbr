...
GO_FAILPOINTS="github.com/DigitalChinaOpenSource/dcbr/pkg/restore/not-leader-error=1*return(true)->1*return(false);\
github.com/DigitalChinaOpenSource/dcbr/pkg/restore/somewhat-retryable-error=3*return(true)" \
